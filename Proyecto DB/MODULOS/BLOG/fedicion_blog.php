...
$id = $_GET ['id'];
$Consulta = "SELECT * FROM blog WHERE ID_User = $id ";
		...
		<div class="col-sm-12">
			...
			<form action="editar_blog.php" method="POST">
				<div class="form-grup">
					...
					<input type="text" name="Titulo" id="Titulo" placeholder="Ingresa el Titulo" class="form-control" value="<?php echo $Fila ['Titulo'];?>">
				</div>
				<div class="form-grup">
					<label for="Telefono_User">Descripcion</label>
					<input type="text" name="Descripcion" id="Descripcion" placeholder="Ingresa la Descripcion" class="form-control" value="<?php echo $Fila ['Descrip'];?>">
				</div>
				<div class="form-grup">
					<label for="Direccion_User">Fecha</label>
					<input type="date" name="Fecha" id="Fecha" placeholder="Ingresa la Fecha" class="form-control" value="<?php echo $Fila ['Fecha'];?>">
				</div>
				<div class="form-grup">
					<label for="Correo_User">Autor</label>
					<input type="text" name="Autor" id="Autor" placeholder="Ingresa el Autor" class="form-control" value="<?php echo $Fila ['Autor'];?>">
